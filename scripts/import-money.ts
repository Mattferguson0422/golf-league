...
const PAYOUT_OVERRIDES: Record<string, number[]> = {
  ...
  "cj-cup": [14, 7, 5],       // 13 entrants × $2 = $26 pool
  ...
  "travelers-championship": [15, 8, 5], // 14 entrants × $2 = $28 pool
  "scottish-open": [15, 8, 5], // 14 entrants × $2 = $28 pool
  ...
  "fedex-st-jude-championship": [13, 7, 4], // 12 entrants × $2 = $24 pool
  "bmw-championship": [14, 7, 5], // 13 entrants × $2 = $26 pool
  "tour-championship": [14, 7, 5], // 13 entrants × $2 = $26 pool
};
